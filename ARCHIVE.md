...
- ✅ prod rp_filter 从 loose (2) → strict (1)：`/etc/sysctl.d/99-rp-filter.conf`
...
- ✅ prod: fail2ban, unattended-upgrades, UFW DROP, certbot.timer active
- ✅ prod: 仅 22/80/443 + Tailscale SOCKS 1080
...
- ⚠️ prod: Docker HTTPS (443) 上的 VectorControl 部署无独立 Let's Encrypt
