...
- VectorControl docs unrelated to rikka-agent were archived externally on 2026-03-13 to `<local>\docs\vectorcontrol-archive`.
...
```powershell
$env:JAVA_HOME='<repo-root>\tmp\jdk17\jdk-17.0.18+8'
