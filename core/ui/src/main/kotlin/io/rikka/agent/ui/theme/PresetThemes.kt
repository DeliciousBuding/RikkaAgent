...
/**
 * Sealed class representing a preset theme with Light, Dark, and AMOLED color schemes.
 */
sealed class PresetTheme(
    val id: String,
    val displayName: String,
    val lightScheme: ColorScheme,
    val darkScheme: ColorScheme,
    val amoledScheme: ColorScheme,
) {
    fun getColorScheme(dark: Boolean, amoled: Boolean): ColorScheme {
        return when {
            amoled && dark -> amoledScheme
            dark -> darkScheme
            else -> lightScheme
        }
    }

    data object Sakura : PresetTheme(
        id = "sakura",
        displayName = "Sakura",
        ...
        amoledScheme = darkColorScheme(
            ...
            onSurface = Color(0xFFF0DEDF),
            surfaceVariant = Color(0xFF1A1112),
            onSurfaceVariant = Color(0xFFD7C1C3),
            outline = Color(0xFF9F8C8E),
            outlineVariant = Color(0xFF524345),
            scrim = Color(0xFF000000),
            ...
            surfaceBright = Color(0xFF1A1112),
            surfaceContainerLowest = Color(0xFF000000),
            surfaceContainerLow = Color(0xFF0A0607),
            surfaceContainer = Color(0xFF140C0D),
            surfaceContainerHigh = Color(0xFF1A1112),
            surfaceContainerHighest = Color(0xFF22191A),
        ),
    )

    data object Ocean : PresetTheme(
        id = "ocean",
        displayName = "Ocean",
        lightScheme = lightColorScheme(
        ...
        amoledScheme = darkColorScheme(
            ...
            surface = Color(0xFF000000),
            onSurface = Color(0xFFDFE3E7),
            surfaceVariant = Color(0xFF0F1417),
            onSurfaceVariant = Color(0xFFC0C8CD),
            outline = Color(0xFF8A9297),
            outlineVariant = Color(0xFF40484C),
            scrim = Color(0xFF000000),
            ...
            inversePrimary = Color(0xFF116682),
            surfaceDim = Color(0xFF000000),
            surfaceBright = Color(0xFF0F1417),
            surfaceContainerLowest = Color(0xFF000000),
            surfaceContainerLow = Color(0xFF050809),
            surfaceContainer = Color(0xFF0A0F11),
            surfaceContainerHigh = Color(0xFF0F1417),
            surfaceContainerHighest = Color(0xFF171C1F),
        ),
    )

    data object Spring : PresetTheme(
        id = "spring",
        displayName = "Spring",
        lightScheme = lightColorScheme(
        ...
        amoledScheme = darkColorScheme(
            ...
            inversePrimary = Color(0xFF4C662B),
            surfaceDim = Color(0xFF000000),
            surfaceBright = Color(0xFF12140E),
            surfaceContainerLowest = Color(0xFF000000),
            surfaceContainerLow = Color(0xFF060704),
            surfaceContainer = Color(0xFF0C0F09),
            surfaceContainerHigh = Color(0xFF12140E),
            surfaceContainerHighest = Color(0xFF1A1C16),
        ),
    )

    data object Autumn : PresetTheme(
        id = "autumn",
        displayName = "Autumn",
        lightScheme = lightColorScheme(
        ...
        amoledScheme = darkColorScheme(
            ...
            surface = Color(0xFF000000),
            onSurface = Color(0xFFEAE1D4),
            surfaceVariant = Color(0xFF16130B),
            onSurfaceVariant = Color(0xFFCFC6B4),
            outline = Color(0xFF989080),
            outlineVariant = Color(0xFF4C4639),
            scrim = Color(0xFF000000),
            ...
            inversePrimary = Color(0xFF735C0C),
            surfaceDim = Color(0xFF000000),
            surfaceBright = Color(0xFF16130B),
            surfaceContainerLowest = Color(0xFF000000),
            surfaceContainerLow = Color(0xFF0B0905),
            surfaceContainer = Color(0xFF110E07),
            surfaceContainerHigh = Color(0xFF16130B),
            surfaceContainerHighest = Color(0xFF1F1B13),
        ),
    )

    data object Black : PresetTheme(
        id = "black",
        displayName = "Black",
        lightScheme = lightColorScheme(
    ...
    companion object {
        val all: List<PresetTheme> = listOf(Sakura, Ocean, Spring, Autumn, Black)

        fun findById(id: String): PresetTheme = all.find { it.id == id } ?: Sakura
    }
}
